  ...
  METHOD if_oo_adt_classrun~main.
    TRY.
        ...
        DATA(lo_http_destination) =
             cl_http_destination_provider=>create_by_url( 'https://sandbox.api.sap.com/s4hanacloud/sap/opu/odata/sap/API_BUSINESS_PARTNER/A_AddressEmailAddress?$inlinecount=allpages&$top=1' ).
        ...
        (  name = 'APIKey' value = 'A7A3x0q5nXFksE8Se6zGdsdx1TD0k2NX' )
